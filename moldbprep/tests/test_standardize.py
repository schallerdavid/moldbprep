...
@pytest.mark.parametrize("input_smiles, output_smiles", [
    ...
    ("O=C(N)C=1C(=O)[C@@]2(O)C(O)=C3C(=O)c4c(O)cccc4[C@H](C)[C@H]3[C@H](O)[C@@H]2[C@H](N(C)C)C=1O",
     "O=C(N)C=1C(=O)[C@@]2(O)C(O)=C3C(=O)c4c(O)cccc4[C@H](C)[C@H]3[C@H](O)[C@@H]2[C@H]([N+H](C)C)C=1[O-]"),
    ...
    ("O=C(Oc1cc2[C@@]3(C)[C@@H](N(C)c2cc1)N(C)CC3)NC", "O=C(Oc1cc2[C@@]3(C)[C@H]([N+H](C)CC3)N(C)c2cc1)NC"),
